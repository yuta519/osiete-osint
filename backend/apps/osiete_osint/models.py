...
class UrlScan(models.Model):
    ...
    primary_ip = CharField(max_length=50, null=True)
    server = CharField(max_length=50, null=True)
    asnname = CharField(max_length=50, null=True)
    asn = CharField(max_length=50, null=True)
